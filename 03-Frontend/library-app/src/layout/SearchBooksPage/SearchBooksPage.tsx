                        ...
                        <div className="col-4">
                            <div className="dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a href="#" className="dropdown-item" onClick={() => categoryField('ALL')}>All</a></li>
                                    <li><a href="#" className="dropdown-item" onClick={() => categoryField('FE')}>Front-End</a></li>
                                    <li><a href="#" className="dropdown-item" onClick={() => categoryField('BE')}>Back-end</a></li>
                                    <li><a href="#" className="dropdown-item" onClick={() => categoryField('DATA')}>Data</a></li>
                                    <li><a href="#" className="dropdown-item" onClick={() => categoryField('DEVOPS')}>Dev-ops</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
