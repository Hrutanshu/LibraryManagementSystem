        ...
        <div>
            <div className="d-none d-lg-block">
                ...
                <div className="row d-0">
                    <div className="col-4 col-md-4 container deflex justify-content-center align-item-center">
                        <div className="ml-2">
                            <h1>Our collection is always changing.</h1>
                            <p className="lead">
                                Try to check in daily as our collection is always changing.
                                We work non stop to provide the most accurate book selection possible
                                for our luv2 read students! We are deligent about our book selection
