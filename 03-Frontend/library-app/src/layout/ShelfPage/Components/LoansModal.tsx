                        ...
                        <div className="modal-body">
                            <div className="container">
                                <div className="mt-3">
                                    ...
                                    {props.shelfCurrentLoan.daysLeft < 0 &&
                                        <p className="text-danger">Past due by {-1 * props.shelfCurrentLoan.daysLeft} days</p>
                                    }
                                    <div className="list-group mt-3">
                                        <button data-bs-dismiss="modal" className="list-group-item list-group-item-action"
                                            aria-current="true" onClick={() => props.returnBook(props.shelfCurrentLoan.book.id)}>Return Book</button>
                                        <button data-bs-dismiss="modal" className={
                                            ...
                                            : 'list-group-item list-group-item-action'} onClick={props.shelfCurrentLoan.daysLeft < 0 
                                            ? (event) => event.preventDefault() : () => props.renewLoan(props.shelfCurrentLoan.book.id)}>
                                                {props.shelfCurrentLoan.daysLeft < 0 ? 'Late dues cannot be renued' : 'Renem loan for 7 days'}
                                        </button>
                                    </div>
                                </div>
                            </div>
