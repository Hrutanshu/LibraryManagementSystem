...
import BookModule from "../../../Models/BookModule";
import { useOktaAuth } from "@okta/okta-react";

export const ChangeQuantityOfBook: React.FC<{book: BookModule, deleteBook: any}> = (props, key) => {
    ...
    return(
        <div className="card mt-3 shadow p-3 mb-3 bg-body rounded">
            <div className="row g-0">
                ...
                <button className="m-1 btn btn-md btn-warning" onClick={decreaseQuantity}>Decrese quantity</button>
            </div>
        </div>
    );
}